...
| autoStart    | (boolean) Defines if the instance start typing automatically. Turn this option to `false` if you want to create chain strings with the `type()`, `delete()` or `pause()` methods.  | true  |
